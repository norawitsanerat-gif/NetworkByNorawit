...
window.DATA = {
  ...
  ch3: {
    ...
    exam: [
      ...
      { q: "DNS ทำหน้าที่อะไร?", options: ["แปลงชื่อโดเมนเป็น IP Address", "เข้ารหัสข้อมูลระหว่างการส่งสัญญาณ", "ส่งอีเมลไปยังผู้รับ", "บีบอัดไฟล์ให้เล็กลง"], correct: 0, explain: "DNS แปลงชื่อโดเมน (www.google.com) เป็น IP Address — เหมือนสมุดโทรศัพท์ของ Internet" },
