...
window.DATA = {
  ...
  quiz: [
    {
      ...
      options: [
        "การเชื่อมต่ออุปกรณ์หลายเครื่องเพื่อสื่อสารและแลกเปลี่ยนข้อมูลกัน",
        "คอมพิวเตอร์เครื่องเดียวที่ทำงานเร็วมาก",
        "ซอฟต์แวร์สำหรับวาดรูปบนคอมพิวเตอร์",
        "สายไฟที่ต่อกับคอมพิวเตอร์"
      ],
      correct: 0,
  ...
  quick: [
    ...
    },
    {
      ...
      options: ["สัญญาณทีวี", "วิทยุสื่อสาร", "การโทรศัพท์ / Video Call", "สัญญาณ GPS"],
      correct: 2,
    ...
    },
    {
      ...
      options: ["Point-to-Point", "Multipoint", "Broadcast", "Mesh"],
      correct: 0,
    ...
    },
    {
      ...
      options: ["ข้อมูลวิ่งช้าเกินไป", "การชนกันของข้อมูล (Collision)", "ไม่มีใครส่งข้อมูลได้", "ใช้สายมากเกินไป"],
      correct: 1,
    ...
    },
    {
      ...
      options: ["ใช้สายน้อยที่สุด", "ถ้าสายหนึ่งขาด เครื่องอื่นยังทำงานต่อได้", "มีหลายเส้นทางสำรอง", "ไม่ต้องใช้อุปกรณ์ศูนย์กลาง"],
      correct: 1,
    ...
    {
      q: "DNS ทำหน้าที่อะไร?",
      options: ["แจก IP Address อัตโนมัติ", "แปลงชื่อโดเมนเป็น IP Address", "เข้ารหัสข้อมูลบนเว็บ", "ส่งสัญญาณ Wi-Fi"],
      correct: 1,
  ...
  ch2: {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ["เส้นทางที่ข้อมูลไหลจริง เช่น สายไฟ ใยแก้ว คลื่นวิทยุ", "เส้นทางสมมติที่ลากผ่านหลายเครือข่าย", "หมายเลข IP ของปลายทาง", "ชื่อโดเมนของเว็บไซต์"],
        correct: 0,
      ...
      },
      {
        ...
        options: [
          "Protocol คือกฎการสื่อสาร ส่วน Service คือสิ่งที่ชั้นบนได้รับจากชั้นล่าง",
          "Protocol คืออุปกรณ์ ส่วน Service คือสายสัญญาณ",
          "Protocol กับ Service คือสิ่งเดียวกัน",
          "Protocol คือฮาร์ดแวร์ ส่วน Service คือซอฟต์แวร์"
        ],
        correct: 0,
      ...
      },
      {
        ...
        options: [
          "เก็บข้อมูลสำคัญ เช่น ที่อยู่ต้นทาง-ปลายทาง พอร์ต และหมายเลขลำดับ",
          "ทำให้ข้อมูลมีขนาดใหญ่ขึ้น",
          "เข้ารหัสข้อมูลทั้งหมด",
          "แทนที่เนื้อหาข้อมูลจริง (Payload)"
        ],
        correct: 0,
      ...
      },
      {
        ...
        options: [
          "อุปกรณ์ปลายทางที่ผู้ใช้ใช้ เช่น คอมพิวเตอร์ มือถือ เซิร์ฟเวอร์",
          "สายไฟและ Router ภายในเครือข่าย",
          "ศูนย์ข้อมูลขนาดใหญ่เท่านั้น",
          "คลื่นสัญญาณ Wi-Fi"
        ],
        correct: 0,
    ...
    exam: [
      { q: "การสื่อสารทางกายภาพ (Physical Communication) คืออะไร?", options: ["สัญญาณจริงที่เดินทางผ่านสายหรืออากาศ", "เส้นทางเชิงตรรกะในซอฟต์แวร์", "ที่อยู่ IP ของอุปกรณ์", "รูปแบบของโปรโตคอล"], correct: 0, explain: "Physical = สัญญาณไฟฟ้า/แสง/คลื่นจริงที่วิ่งบนสายหรืออากาศ ส่วน Logical คือเส้นทางเชิงตรรกะที่ซอฟต์แวร์กำหนด" },
      { q: "เส้นทางเชิงตรรกะ (Logical Path) ต่างจากทางกายภาพอย่างไร?", options: ["ใช้สายไฟจริงที่มองเห็นได้", "กำหนดโดยซอฟต์แวร์/โปรโตคอล ไม่ผูกกับสายเส้นเดียว", "ใช้ได้เฉพาะใน LAN", "ไม่มีข้อมูลเดินทาง"], correct: 1, explain: "Logical Path เป็นเส้นทางที่ซอฟต์แวร์กำหนด — ข้อมูลอาจวิ่งผ่านสายหลายเส้นแต่ตรรกะมองเป็นเส้นเดียว" },
      { q: "End System / Host คืออะไร?", options: ["อุปกรณ์ที่รันแอปพลิเคชันที่ปลายเครือข่าย เช่น PC, โทรศัพท์, เซิร์ฟเวอร์", "อุปกรณ์กลางอย่าง Router", "สายเคเบิล", "ซอฟต์แวร์ระบบปฏิบัติการ"], correct: 0, explain: "End System = อุปกรณ์ปลายทางที่รันแอป (Host) ส่วน Router/Switch เป็นอุปกรณ์กลางที่แค่ส่งต่อข้อมูล" },
      { q: "อุปกรณ์ใดต่อไปนี้เป็น End System?", options: ["Router", "เว็บเซิร์ฟเวอร์", "Switch", "Access Point"], correct: 1, explain: "เว็บเซิร์ฟเวอร์รันแอปพลิเคชัน (เว็บ) ที่ปลายเครือข่ายจึงเป็น End System ส่วน Router/Switch เป็นอุปกรณ์กลาง" },
      ...
      { q: "ชั้นที่อยู่ใกล้ผู้ใช้มากที่สุดคือชั้นใด?", options: ["Physical", "Transport", "Application", "Network"], correct: 2, explain: "Application Layer อยู่ใกล้ผู้ใช้ที่สุด — เป็นชั้นที่แอปอย่างเว็บ/อีเมลทำงานอยู่" },
      ...
      { q: "Encapsulation คืออะไร?", options: ["การห่อข้อมูลเพิ่ม Header ทีละชั้นตอนส่ง", "การแกะ Header ออกตอนรับ", "การแบ่งข้อมูลเป็นชิ้นเล็ก", "การเข้ารหัสข้อมูล"], correct: 0, explain: "Encapsulation = การห่อข้อมูลเพิ่ม Header ทีละชั้น (จากบนลงล่าง) ตอนส่งข้อมูล" },
      { q: "De-encapsulation คืออะไร?", options: ["การห่อข้อมูลเพิ่ม Header", "การแกะ Header ออกทีละชั้นตอนรับ", "การค้นหาเส้นทาง", "การบีบอัดข้อมูล"], correct: 1, explain: "De-encapsulation = การแกะ Header ออกทีละชั้น (จากล่างขึ้นบน) ตอนฝั่งรับข้อมูล" },
      { q: "Header ของข้อมูลใช้เก็บอะไร?", options: ["เฉพาะเนื้อหาข้อมูลจริง", "ข้อมูลควบคุม เช่น ที่อยู่ พอร์ต ลำดับ Checksum", "เฉพาะรูปภาพ", "รหัสผ่านของเครื่อง"], correct: 1, explain: "Header เก็บข้อมูลควบคุม (ที่อยู่ พอร์ต ลำดับ Checksum) ส่วนเนื้อหาจริงเรียกว่า Payload" },
      { q: "การสื่อสารระหว่าง Host จริง ๆ คือการสื่อสารระหว่างอะไร?", options: ["เครื่องกับเครื่อง", "Process กับ Process", "Router กับ Router", "สายกับสาย"], correct: 1, explain: "การสื่อสารระหว่างเครื่องจริง ๆ คือการสื่อสารระหว่าง Process (โปรแกรมที่กำลังทำงาน) กับ Process" },
      { q: "Protocol กับ Service ต่างกันอย่างไร?", options: ["Protocol = กฎ/รูปแบบการสื่อสาร, Service = สิ่งที่ชั้นล่างมอบให้ชั้นบน", "เหมือนกันทุกประการ", "Service = กฎ, Protocol = บริการ", "ไม่มีคำจำกัดความ"], correct: 0, explain: "Protocol คือกฎ/รูปแบบการสื่อสาร เช่น TCP, IP ส่วน Service คือบริการที่ชั้นล่างมอบให้ชั้นบน เช่น 'ส่งข้อมูลให้ครบถ้วน'" },
      { q: "ชั้น Transport มีหน้าที่หลักอะไร?", options: ["แปลงสัญญาณเป็นบิต", "เชื่อมต่อ Process ต่อ Process + รับประกันความเชื่อถือได้", "หาเส้นทางระหว่างเครือข่าย", "แสดงผลเว็บเพจ"], correct: 1, explain: "Transport Layer เชื่อมต่อ Process ต่อ Process และจัดการเรื่องความเชื่อถือได้ (TCP) หรือความเร็ว (UDP)" },
      { q: "Physical Layer ส่งข้อมูลในรูปแบบใด?", options: ["Segment", "Packet", "Bits (สัญญาณ 0/1)", "Frame"], correct: 2, explain: "Physical Layer ส่งข้อมูลเป็น Bits — สัญญาณไฟฟ้า/แสง/คลื่นแม่เหล็กไฟฟ้าจริงบนสายหรืออากาศ" },
      ...
      { q: "PDU ของ Transport Layer เรียกว่าอะไร?", options: ["Frame", "Segment", "Packet", "Datagram"], correct: 1, explain: "Transport Layer เรียกว่า Segment (TCP/UDP) — ประกอบด้วย Header ของ Transport + ข้อมูลจากชั้นบน" },
      ...
      { q: "ข้อดีของการแบ่งเป็นชั้น (Layered Model) คืออะไร?", options: ["แยกหน้าที่ชัดเจน แก้ไข/พัฒนาทีละชั้นได้", "เครื่องทำงานเร็วขึ้น", "ไม่ต้องใช้สาย", "ลดจำนวนอุปกรณ์"], correct: 0, explain: "โมเดลแบบชั้นแยกหน้าที่ชัดเจน — เปลี่ยนเทคโนโลยีทีละชั้นได้โดยไม่กระทบชั้นอื่น (เช่น เปลี่ยนสายแต่ Protocol เดิม)" }
    ]
  },
  ...
  ch3: {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: ["ที่อยู่ของเครื่องทั้งเครื่อง", "ประตูที่ Process ใช้ส่ง/รับข้อมูล", "สายไฟที่เชื่อมอุปกรณ์", "รหัสผ่านของเครือข่าย"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["ส่งอีเมล", "เกมออนไลน์แบบ Real-time", "ดาวน์โหลดไฟล์", "อัปโหลดรูปภาพ"],
        correct: 1,
      ...
      },
      {
        ...
        options: ["HTTPS เข้ารหัสข้อมูลด้วย TLS/SSL ส่วน HTTP ไม่เข้ารหัส", "HTTP เร็วกว่า HTTPS เสมอ", "HTTPS ใช้ได้เฉพาะกับไฟล์รูปภาพ", "ทั้งสองเหมือนกันทุกอย่าง"],
        correct: 0,
      ...
      },
      {
        ...
        options: [
          "เซิร์ฟเวอร์จำข้อมูลของ request ก่อนหน้าได้",
          "เซิร์ฟเวอร์ไม่จำข้อมูลของ request ก่อนหน้า แต่ละ request เป็นเรื่องใหม่",
          "HTTP ใช้การเชื่อมต่อถาวรตลอดไป",
          "HTTP ไม่มีโปรโตคอลรองรับการส่งข้อมูล"
        ],
        correct: 1,
      ...
      },
      {
        ...
        options: [
          "ใช้การเชื่อมต่อ TCP เดียวส่งหลาย request/response ต่อเนื่องกัน ไม่ต้อง handshake ใหม่ทุกครั้ง",
          "ไม่ต้องใช้ TCP เลย",
          "ส่งข้อมูลได้ครั้งละ 1 ไบต์เท่านั้น",
          "เข้ารหัสข้อมูลทุกครั้ง"
        ],
        correct: 0,
      ...
      },
      {
        ...
        options: [
          "ลดความหน่วง (Delay) และลดภาระ DNS Server เพราะไม่ต้องถามซ้ำทุกครั้ง",
          "ทำให้เว็บไซต์ใหญ่ขึ้น",
          "เข้ารหัสข้อมูลทั้งหมด",
          "เพิ่มแบนด์วิดท์"
        ],
        correct: 0,
    ...
    /* ข้อสอบหลังเรียน — บททดสอบท้ายบท 20 ข้อ (ปลดล็อกเมื่อเรียนครบทุกสไลด์) */
    exam: [
      { q: "สถาปัตยกรรม Client-Server ต่างจาก P2P อย่างไร?", options: ["มี Server กลางคอยให้บริการ ส่วน P2P แต่ละเครื่องเป็นทั้งผู้ให้และผู้ขอ", "Client-Server ไม่มี Server", "P2P ต้องมี Server กลาง", "เหมือนกันทุกประการ"], correct: 0, explain: "Client-Server มี Server กลางรอรับคำขอ ส่วน P2P แต่ละเครื่อง (peer) เป็นทั้งผู้ให้และผู้ขอในเวลาเดียวกัน" },
      ...
      { q: "Process คืออะไร?", options: ["โปรแกรมที่กำลังทำงานอยู่บนเครื่อง", "สายเคเบิล", "ที่อยู่ของเครื่อง", "ชนิดของข้อมูล"], correct: 0, explain: "Process คือโปรแกรมที่กำลังทำงานอยู่ เช่น เบราว์เซอร์ที่เปิดอยู่คือ 1 Process" },
      { q: "Socket คืออะไร?", options: ["ที่อยู่ของเครื่องทั้งเครื่อง", "ประตูที่ Process ใช้ส่ง/รับข้อมูลเข้า-ออกเครือข่าย", "รหัสผ่าน", "หน่วยความจำ"], correct: 1, explain: "Socket คือ 'ประตู' ที่ Process ใช้ส่ง/รับข้อมูล (IP = บ้าน, Port = ห้อง, Socket = ประตูของห้องนั้น)" },
      { q: "IP Address ใช้ระบุอะไร?", options: ["Process บนเครื่อง", "เครื่อง (Host) บนเครือข่าย", "ประเภทของสาย", "ความเร็วเน็ต"], correct: 1, explain: "IP Address ระบุเครื่อง (Host) บนเครือข่าย — บอกว่า 'บ้านหลังไหน' ส่วน Port บอกว่า 'ห้องไหน'" },
      { q: "Port Number ใช้ระบุอะไร?", options: ["เครื่องปลายทาง", "Process ใดบน host นั้นเป็นผู้รับ/ส่งข้อมูล", "ยี่ห้ออุปกรณ์", "ความแรงสัญญาณ"], correct: 1, explain: "Port ระบุ Process ปลายทางบน host — Transport Layer ใช้ IP Address + Port Number คู่กันเสมอ" },
      ...
      { q: "แอปใดต้องการ Delay ต่ำที่สุด?", options: ["ส่งอีเมล", "เกมออนไลน์แบบ Real-time", "ดาวน์โหลดไฟล์", "อัปโหลดรูป"], correct: 1, explain: "เกมออนไลน์/วิดีโอคอลต้องการความหน่วงต่ำมาก ส่วนอีเมลหรือดาวน์โหลดไฟล์ไม่ซีเรียสเรื่อง Delay" },
      ...
      { q: "HTTPS ปลอดภัยกว่า HTTP เพราะเหตุใด?", options: ["เร็วกว่า", "เข้ารหัสข้อมูลด้วย TLS/SSL", "ใช้สาย Fiber", "มี Server มากขึ้น"], correct: 1, explain: "HTTPS เข้ารหัสข้อมูลด้วย TLS/SSL ก่อนส่ง — คนแอบดักฟังระหว่างทางอ่านข้อมูลไม่ออก" },
      { q: "Stateless หมายถึงอะไร?", options: ["Server จำทุก request", "Server ไม่จำข้อมูล request ก่อนหน้า — แต่ละ request เป็นเรื่องใหม่", "Server เก็บข้อมูลตลอด", "การเชื่อมต่อถาวร"], correct: 1, explain: "HTTP เป็น Stateless — Server ไม่จำ request ก่อนหน้า (ถ้าอยากจำต้องใช้กลไกเสริมอย่าง Cookies)" },
      { q: "Persistent Connection ต่างจาก Non-Persistent อย่างไร?", options: ["ใช้ TCP เดียวส่งหลาย request ต่อเนื่อง / เปิด-ปิด TCP ใหม่ทุก request", "Persistent ช้ากว่า", "Non-Persistent ใช้ UDP", "ไม่ต่างกัน"], correct: 0, explain: "Persistent ใช้ TCP เดียวส่งหลาย request ต่อเนื่อง (ค่า default ของ HTTP/1.1) ส่วน Non-Persistent เปิด-ปิด TCP ใหม่ทุกครั้ง → ช้ากว่า" },
      { q: "HTTP Request บรรทัดแรกเรียกว่าอะไร?", options: ["Status Line", "Request Line", "Header Line", "Body"], correct: 1, explain: "Request Line = Method + URL + Version เช่น GET /index.html HTTP/1.1 ส่วน Response ใช้ Status Line" },
      { q: "HTTP Status 404 หมายถึงอะไร?", options: ["สำเร็จ", "เปลี่ยนเส้นทาง", "หาไฟล์/หน้าเว็บไม่เจอ", "Server พัง"], correct: 2, explain: "404 Not Found = หาไฟล์/หน้าเว็บไม่เจอ ส่วน 200 OK = สำเร็จ, 500 = Server มีปัญหา" },
      ...
      { q: "POST เหมาะกับงานใด?", options: ["เปิดหน้าเว็บ", "กรอกฟอร์มสมัครสมาชิก", "ค้นหา Google", "โหลดรูป"], correct: 1, explain: "POST ส่งข้อมูลใน Body เพื่อสร้าง/ประมวลผล เช่น ฟอร์มสมัครสมาชิก — ไม่โชว์ข้อมูลบน URL" },
      { q: "DNS ทำหน้าที่อะไร?", options: ["แปลงชื่อโดเมนเป็น IP Address", "เข้ารหัสข้อมูล", "ส่งอีเมล", "บีบอัดไฟล์"], correct: 0, explain: "DNS แปลงชื่อโดเมน (www.google.com) เป็น IP Address — เหมือนสมุดโทรศัพท์ของ Internet" },
      { q: "DNS Cache ช่วยอะไร?", options: ["ทำให้เร็วขึ้นเพราะไม่ต้องถาม DNS ซ้ำ ลด Delay", "เก็บรหัสผ่าน", "เพิ่มความปลอดภัย", "ลบข้อมูล"], correct: 0, explain: "DNS Cache เก็บคำตอบที่เคยถามไว้ชั่วคราว — ตอบได้ทันทีไม่ต้องถาม DNS Server ใหม่ ลด Delay และภาระ Server" },
...
window.DATA.ch4 = {
  ...
  quiz: [
    {
      ...
      options: [
        "กำหนดเส้นทางข้ามเครือข่าย",
        "เชื่อมต่อระหว่าง Process กับ Process (ให้บริการแก่ Application)",
        "แปลงสัญญาณไฟฟ้าเป็นบิต",
        "เข้ารหัสข้อมูลทั้งหมด"
      ],
      correct: 1,
    ...
    },
    {
      ...
      options: [
        "แยกข้อมูลไปยัง process ปลายทางที่ถูกต้อง",
        "รวมข้อมูลจากหลาย Socket/Process ลงสู่เครือข่ายเดียว",
        "บีบอัดข้อมูลให้เล็กลง",
    ...
    },
    {
      ...
      options: [
        "ระบุ process ปลายทางบนเครื่องผู้รับ",
        "ระบุ process ต้นทาง เพื่อให้ฝั่งรับรู้ว่าจะตอบกลับไปที่ไหน",
        "บอกขนาดของข้อมูล",
    ...
    },
    {
      ...
      options: [
        "TCP เชื่อถือได้ (Reliable) ส่วน UDP ไม่มีการรับประกัน",
        "UDP เชื่อถือได้ ส่วน TCP ไม่มี",
        "ทั้งสองเหมือนกันทุกอย่าง",
        "TCP ใช้ไม่ได้กับอินเทอร์เน็ต"
      ],
      correct: 0,
    ...
    },
    {
      ...
      options: [
        "ตรวจความผิดพลาดของข้อมูล (Bit Error) — detect เท่านั้น ไม่แก้ไข",
    ...
    },
    {
      ...
      options: [
        "การตรวจจับข้อผิดพลาด + ACK/NAK ให้ผู้ส่งรู้ว่าข้อมูลถึงถูกต้องหรือไม่",
        "การบีบอัดข้อมูล",
        "การเข้ารหัสข้อมูล",
        "การเลือกเส้นทาง"
      ],
    ...
    },
    {
      ...
      options: [
        "Sequence Number + จำนวนไบต์ที่รับ (Cumulative ACK)",
        "จำนวนไบต์ที่ส่งทั้งหมด ÷ 2",
        "ขนาดของ TCP Header",
        "เวลาที่ใช้ในการส่ง"
      ],
      correct: 0,
    ...
    },
    {
      ...
      options: [
        "Additive Increase (เพิ่มทีละน้อย) / Multiplicative Decrease (ลดครึ่งเมื่อมี Loss)",
        "Always Increase / Multiple Delay",
        "Auto Internet / Manual Download",
        "Add IP / Modify Data"
      ],
      correct: 0,
  ...
  exam: [
    ...
    { q: "PDU ของ Transport Layer เรียกว่าอะไร?", options: ["Frame", "Packet", "Segment", "Bit"], correct: 2, explain: "Transport Layer เรียกว่า Segment ส่วน Packet เป็นของ Network Layer และ Frame เป็นของ Data Link" },
    { q: "Multiplexing คืออะไร?", options: ["แยกข้อมูลไปหลาย Socket", "รวมข้อมูลจากหลาย Socket ลงช่องทางเดียว", "เข้ารหัสข้อมูล", "แบ่งข้อมูลเป็นชิ้น"], correct: 1, explain: "Multiplexing = ฝั่งส่งรวมข้อมูลจากหลาย Socket/Process ลงสู่เครือข่ายเดียว" },
    { q: "Demultiplexing คืออะไร?", options: ["รวมข้อมูลหลาย Socket", "แยกข้อมูลไปยัง Socket ที่ถูกต้องฝั่งรับ", "หาเส้นทาง", "ตรวจสอบข้อมูล"], correct: 1, explain: "Demultiplexing = ฝั่งรับแยกข้อมูลไปยัง Socket ที่ถูกต้อง โดยดูจาก Port Number" },
    { q: "TCP 4-tuple ประกอบด้วยอะไรบ้าง?", options: ["Src IP + Src Port + Dst IP + Dst Port", "Src IP + Dst IP เท่านั้น", "Src Port + Dst Port เท่านั้น", "MAC + IP + Port + Checksum"], correct: 0, explain: "4-tuple = ที่อยู่ครบทั้ง 4: IP ต้นทาง/ปลายทาง + Port ต้นทาง/ปลายทาง — ใช้แยกการเชื่อมต่อ TCP แต่ละอัน" },
    { q: "Source Port ใช้บอกอะไร?", options: ["Process ปลายทาง", "Process ต้นทาง (ฝั่งรับจะตอบกลับที่นี่)", "ขนาดข้อมูล", "ความเร็ว"], correct: 1, explain: "Source Port ระบุ Process ต้นทาง — ฝั่งรับใช้ค่านี้เพื่อส่งข้อมูลตอบกลับ" },
    { q: "ข้อใดเป็นความต่างหลักระหว่าง TCP กับ UDP?", options: ["TCP เชื่อถือได้+มีลำดับ / UDP เร็ว+ไม่มี Connection", "TCP เร็วกว่า", "UDP เชื่อถือได้กว่า", "ไม่ต่างกัน"], correct: 0, explain: "TCP เน้นความเชื่อถือได้ (Reliable, มีลำดับ, Flow/Congestion Control) ส่วน UDP เน้นความเร็ว ไร้ Connection" },
    ...
    { q: "UDP Header ประกอบด้วยช่องใดบ้าง?", options: ["Src Port, Dst Port, Length, Checksum", "Src IP, Dst IP, Seq, Ack", "SYN, ACK, FIN, RST", "TTL, Type, Code, ID"], correct: 0, explain: "UDP Header มี 4 ช่อง: Source Port, Destination Port, Length, Checksum" },
    { q: "UDP Checksum ใช้ทำอะไร?", options: ["เข้ารหัสข้อมูล", "ตรวจจับความผิดพลาดของข้อมูล (Bit Error)", "หาเส้นทาง", "บีบอัดข้อมูล"], correct: 1, explain: "UDP Checksum ตรวจความผิดพลาดของข้อมูล (Header + Data) — ตรวจจับได้แต่ไม่แก้ไข (ถ้าเสียต้องส่งใหม่โดยแอป)" },
    { q: "rdt1.0 สมมติว่าช่องทางเป็นแบบใด?", options: ["มี Error บ่อย", "สมบูรณ์ ไม่มี Error", "ช้ามาก", "ไม่มีการส่ง"], correct: 1, explain: "rdt1.0 สมมติช่องทางสมบูรณ์แบบ — ส่งอย่างเดียว ไม่ต้องตรวจสอบอะไร" },
    { q: "rdt2.0 เพิ่มกลไกใดเข้ามา?", options: ["Error Detection + ACK/NAK", "การเข้ารหัส", "การบีบอัด", "Flow Control"], correct: 0, explain: "rdt2.0 เพิ่มการตรวจจับ Error และการตอบ ACK (รับถูก) / NAK (ขอส่งใหม่)" },
    { q: "ACK หมายถึงอะไร?", options: ["ขอส่งใหม่", "ยืนยันว่ารับข้อมูลถูกต้อง", "ปิดการเชื่อมต่อ", "เริ่มการเชื่อมต่อ"], correct: 1, explain: "ACK (Acknowledgement) = ยืนยันว่ารับข้อมูลถูกต้อง ส่วน NAK = บอกว่าข้อมูลเสีย ขอส่งใหม่" },
    ...
    { q: "SYN ใช้ทำอะไร?", options: ["ขอเริ่มการเชื่อมต่อ", "ขอปิดการเชื่อมต่อ", "ยืนยันรับข้อมูล", "ส่งข้อมูล"], correct: 0, explain: "SYN ใช้เริ่มการเชื่อมต่อ ส่วน FIN ใช้ขอยุติการเชื่อมต่อ" },
    { q: "การคำนวณ ACK Number ใช้สูตรใด?", options: ["Seq# − จำนวนไบต์", "Seq# + จำนวนไบต์ที่รับ (Cumulative)", "จำนวนไบต์ × 2", "Seq# × จำนวนไบต์"], correct: 1, explain: "ACK# = Seq# + จำนวนไบต์ที่รับแล้ว (Cumulative) — บอกว่าข้อมูลถึงไบต์ไหนถัดไป" },
    ...
    { q: "Duplicate ACK 3 ตัวติดต่อกันหมายถึงอะไร?", options: ["ส่งข้อมูลสำเร็จ", "น่าจะ Packet หาย → Fast Retransmit", "ปิดการเชื่อมต่อ", "เพิ่มความเร็ว"], correct: 1, explain: "Duplicate ACK 3 ตัว = สงสัย Packet หาย → ส่งซ้ำทันที (Fast Retransmit) โดยไม่ต้องรอ Timeout" },
    { q: "Internet Checksum ตรวจสอบข้อมูลแบบใด?", options: ["1's complement sum", "2's complement", "CRC 32 บิต", "การเข้ารหัส AES"], correct: 0, explain: "Internet Checksum ใช้ 1's complement sum ของข้อมูล — ง่าย เร็ว แต่ตรวจ error ได้ไม่ละเอียดเท่า CRC" }
  ]
};
